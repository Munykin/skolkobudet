...
function selects(el) { //extend Selects
	...
	el.dummy.style.width = /*el.offsetWidth + */291 + 'px';
	el.dummy.ref = el;
	el.left = document.createElement('img');
	el.left.src = imagesPath + "0.png";
	...
	el.dummy.onclick = function() {
		...
		if(this.ref.opt.offsetHeight > selectMaxHeight) {
			this.ref.bg.style.width = /*this.ref.offsetWidth - selectRightWidthScroll*/524 + 33 + 'px';
			this.ref.opt.style.width = /*this.ref.offsetWidth - selectRightWidthScroll*/534 + 'px';
		}
		else {
			this.ref.bg.style.width = /*this.ref.offsetWidth - selectRightWidthSimple*/272 + 33 + 'px';
			this.ref.opt.style.width = /*this.ref.offsetWidth - selectRightWidthSimple*/272 + 'px';
		}
	}
